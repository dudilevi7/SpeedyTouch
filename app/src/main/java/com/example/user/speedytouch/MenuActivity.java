...
public class MenuActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fcBtn = findViewById(R.id.football_btn);
        ...
        fcBtn.animate().translationY(300).setDuration(1000);
        ...
        fcBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) { //case for fc logos
                ObjectAnimator animator = ObjectAnimator.ofFloat(fcBtn,"rotation", 360).setDuration(750);
                animator.start();
                animator.addListener(new AnimatorListenerAdapter() {
